...
// UniversalLabProgram.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CUniversalLabProgramApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CUniversalLabProgramApp

CUniversalLabProgramApp::CUniversalLabProgramApp()
{
...
// Единственный объект CUniversalLabProgramApp

CUniversalLabProgramApp theApp;


// Инициализация CUniversalLabProgramApp

BOOL CUniversalLabProgramApp::InitInstance()
{
